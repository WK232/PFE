...
def infer_and_visualize(args, genotype, test_loader, NUM_CLASSES, device):
    ...
    model.load_state_dict(torch.load('/home/kharratw/Documents/tessssst/PFE/DARTS_WITH_DATASET/eval-EXP-20250612-164244/DARTS.pth', map_location=device))
    model.to(device)
    model.eval()
    with torch.no_grad():
...
# Usage example:
test_dataset = CoherencePhaseSegmentationDataset('/home/kharratw/Documents/tessssst/PFE/ReadyToBeUsedDataset', transform=None, target_transform=None)
